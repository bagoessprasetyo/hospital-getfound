...
-- This migration inserts 10 records for each table with realistic, interconnected data

-- First, create auth users (required for user_profiles foreign key)
...
-- Now insert user profiles (10 doctors + 10 patients + 1 admin)
