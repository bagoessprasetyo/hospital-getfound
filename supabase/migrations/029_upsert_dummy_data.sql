-- Upsert comprehensive dummy data (handles existing data gracefully)
-- This migration uses ON CONFLICT to update existing records or insert new ones

-- Insert or update auth users (required for user_profiles foreign key)
...
-- Insert or update user profiles (10 doctors + 10 patients + 1 admin)
...
-- Insert or update hospitals (10 records)
...
-- Insert or update doctors (10 records)
...
-- Insert or update patients (10 records)
...
-- Clear and re-insert doctor_hospitals relationships (each doctor works at 1-3 hospitals)
DELETE FROM doctor_hospitals WHERE doctor_id IN (
...
-- Clear and re-insert doctor availability (10 records with realistic schedules)
...
-- Clear and re-insert appointments (10 records with realistic future dates)
...
('77777777-7777-7777-7777-777777777771', '55555555-5555-5555-5555-555555555551', '44444444-4444-4444-4444-444444444441', '33333333-3333-3333-3333-333333333331', '2024-02-15', '09:00:00', 'pending', 'Patient reports intermittent chest discomfort'),
('77777777-7777-7777-7777-777777777772', '55555555-5555-5555-5555-555555555552', '44444444-4444-4444-4444-444444444450', '33333333-3333-3333-3333-333333333331', '2024-02-16', '10:30:00', 'confirmed', 'Regular check-up for blood sugar management'),
('77777777-7777-7777-7777-777777777773', '55555555-5555-5555-5555-555555555553', '44444444-4444-4444-4444-444444444443', '33333333-3333-3333-3333-333333333337', '2024-02-17', '14:00:00', 'pending', 'Follow-up after previous knee surgery'),
('77777777-7777-7777-7777-777777777774', '55555555-5555-5555-5555-555555555554', '44444444-4444-4444-4444-444444444442', '33333333-3333-3333-3333-333333333334', '2024-02-18', '11:20:00', 'confirmed', 'Routine pediatric examination'),
('77777777-7777-7777-7777-777777777775', '55555555-5555-5555-5555-555555555555', '44444444-4444-4444-4444-444444444445', '33333333-3333-3333-3333-333333333335', '2024-02-19', '15:00:00', 'pending', 'Severe headaches affecting daily activities'),
('77777777-7777-7777-7777-777777777776', '55555555-5555-5555-5555-555555555556', '44444444-4444-4444-4444-444444444444', '33333333-3333-3333-3333-333333333331', '2024-02-20', '16:30:00', 'confirmed', 'Persistent rash on arms and legs'),
('77777777-7777-7777-7777-777777777777', '55555555-5555-5555-5555-555555555557', '44444444-4444-4444-4444-444444444446', '33333333-3333-3333-3333-333333333336', '2024-02-21', '13:00:00', 'pending', 'Monitoring thyroid hormone levels'),
('77777777-7777-7777-7777-777777777778', '55555555-5555-5555-5555-555555555558', '44444444-4444-4444-4444-444444444448', '33333333-3333-3333-3333-333333333339', '2024-02-22', '10:00:00', 'confirmed', 'Family history requires regular screening'),
('77777777-7777-7777-7777-777777777779', '55555555-5555-5555-5555-555555555559', '44444444-4444-4444-4444-444444444447', '33333333-3333-3333-3333-333333333338', '2024-02-23', '14:00:00', 'pending', 'Anxiety and depression management'),
('77777777-7777-7777-7777-777777777780', '55555555-5555-5555-5555-555555555560', '44444444-4444-4444-4444-444444444449', '33333333-3333-3333-3333-333333333340', '2024-02-24', '12:00:00', 'confirmed', 'Chronic lower back pain assessment');