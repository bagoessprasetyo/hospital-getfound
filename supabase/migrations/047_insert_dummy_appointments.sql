-- Insert dummy appointment data for doctor.test@hospital.demo
-- This migration creates diverse appointment records for testing purposes

-- First, let's get the patient IDs we'll use for appointments
-- We'll use the existing patients from user_profiles
